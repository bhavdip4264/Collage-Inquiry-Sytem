<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_quation.aspx.cs" Inherits="addquation" %>
                                                     ...
                                                     <tr>
                                                        <td class="auto-style18">
                                                            <a href="add_quation.aspx">
                                                                 <asp:Button ID="add_quation" class="style15" runat="server" Text="Add Quations" Height="50px" width="200px" Font-Bold="true" OnClick="addquation_Click" BackColor="#CCCCCC" ForeColor="#003399"/>
                                                            </a>
                                                        </td>
                                                    </tr>
