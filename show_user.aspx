<%@ Page Language="C#" AutoEventWireup="true" CodeFile="show_user.aspx.cs" Inherits="_Default" %>
                                                    ...
                                                    <tr>
                                                        <td class="auto-style18">
                                                            <a href="show_user.aspx">
                                                                 <asp:Button ID="showuser" class="style15" runat="server" Text="Show User" Height="50px" width="200px" Font-Bold="true" OnClick="showuser_Click" BorderColor="Black" BorderStyle="Groove" BackColor="#CCCCCC" ForeColor="#003399" />
                                                            </a>
                                                        </td>
                                                    </tr>
                                                     <tr>
