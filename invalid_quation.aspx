<%@ Page Language="C#" AutoEventWireup="true" CodeFile="invalid_quation.aspx.cs" Inherits="invalid_quation" %>
                                                     ...
                                                     <tr>
                                                        <td class="auto-style18">
                                                            <a href="add_quation.aspx">
                                                                 <asp:Button ID="invalidquation" class="style15" runat="server" Text="Invalid Quation" Height="50px" width="200px" Font-Bold="true" OnClick="invalidquation_Click" BackColor="#CCCCCC" ForeColor="#003399"/>
                                                            </a>
                                                        </td>
                                                    </tr>
